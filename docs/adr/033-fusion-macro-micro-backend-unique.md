# ADR-033 — Fusion « macro + micro » dans un backend unique (Tik ⨉ btc-research-lab)
...
4. Verdict écrit (SUPPORTED/REFUTED) dans un futur ADR-034, comme `RESEARCH.md` le fait déjà.
...
- **Étape 4** — **mesure ≥ 2 sem** (§6) → ADR-034 verdict.
